    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="project-box wow fadeIn" data-bg="#faf8ed">
          <figure> <a href="../images/ayran1.png" data-fancybox><img src="../images/ayran1.png" alt="Image"></a></figure>
          <div class="content-box">
            <div class="inner"> 
              <!-- <small>AMAZING USER INTERFACE & SMOOTH INTERACTION</small> -->
              <h3><span>Non-alcoholic, milk drink (airan)  

              </span>"TAN"</h3>
              <div class="custom-link"> <a href="#">
                <div class="lines"> <span></span> <span></span> </div>
                <!-- end lines --> 
                <b> in heat-resistant PET bottles of 0.5 l and 1 l
                  GMO free. Shelf life 90 days.
                </b></a> </div>
                <!-- end custom-link --> 
              </div>
              <!-- end inner --> 
          ...
          <div class="project-box wow fadeIn" data-bg="#ece6f4">
            <figure> <a href="../images/ayran2.png" data-fancybox><img src="../images/ayran2.png" alt="Image"></a></figure>
            <div class="content-box">
              <div class="inner"> 
                <!-- <small>AMAZING USER INTERFACE & SMOOTH INTERACTION</small> -->
                <h3><span>Non-alcoholic, milk drink (airan)  
